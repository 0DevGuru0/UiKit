...
export const mainSection = [
  ...
  {
    href: '',
    label: 'Users and Authority Groups',
    icon: <Users />,
    iconFilled: <Users />,
    child: [
      {
      ...
      },
      {
        ...
        href: '/admin/user-management/authorityGroups',
      },
      {
        label: 'Collection Access Management',
        href: '/admin/user-management/authorizationRules',
      },
    ],
  },
  {
    ...
    child: [
      {
        label: 'Schemas',
        href: '/admin/schemas-layouts/schemas',
      },
      {
        label: 'Layouts',
        href: '/admin/schemas-layouts/layouts',
      },
    ],
  },
  {
...
export const sidebarsConfig: Config[] = [
  {
    userData: {
      fullName: 'John Doe',
      image: avatarImg,
