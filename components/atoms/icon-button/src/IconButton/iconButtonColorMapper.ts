...
const isString = (item: string | ObjectRecord | SectionColor): item is string => {
...
export const iconButtonColorMapper = (
  config: ConfigType,
  ...
  return {
    ...
    hoverBackgroundColor: hoverBackgroundColor ?? defaultValues.hoverBackgroundColor,
